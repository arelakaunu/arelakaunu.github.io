...
read_time: true
order: 2
project_type: "Notebooks and report"
stack: "Python · Signal processing · Machine learning"
excerpt: "Engineering accelerometer features to distinguish six activities, then comparing gradient boosting and random forests."
---

[← All projects](/portfolio/){: .project-back}

[View project on GitHub](https://github.com/arelakaunu/msc-data-science-portfolio/tree/main/projects/human-activity-recognition){: .btn .btn--primary}
...
[Read the original report](/assets/portfolio/human-activity-recognition/report.pdf) or start with [feature engineering](https://github.com/arelakaunu/msc-data-science-portfolio/blob/main/projects/human-activity-recognition/02-feature-engineering.ipynb).
...
![Activity class distribution from the submitted EDA notebook](/assets/portfolio/human-activity-recognition/activity-distribution.png)

*Original coursework output: the training data are imbalanced across the six activities.*
...
1. [01-preprocessing.ipynb](https://github.com/arelakaunu/msc-data-science-portfolio/blob/main/projects/human-activity-recognition/01-preprocessing.ipynb): create baseline feature/label files in `data-prep/`.
2. [02-feature-engineering.ipynb](https://github.com/arelakaunu/msc-data-science-portfolio/blob/main/projects/human-activity-recognition/02-feature-engineering.ipynb): extract new signal features into `data-preprocess/new/`.
3. [03-eda.ipynb](https://github.com/arelakaunu/msc-data-science-portfolio/blob/main/projects/human-activity-recognition/03-eda.ipynb): explore baseline and engineered features.
4. [04-gradient-boosting.ipynb](https://github.com/arelakaunu/msc-data-science-portfolio/blob/main/projects/human-activity-recognition/04-gradient-boosting.ipynb): train and evaluate GBM.
5. [05-random-forest.ipynb](https://github.com/arelakaunu/msc-data-science-portfolio/blob/main/projects/human-activity-recognition/05-random-forest.ipynb): train, tune, and evaluate RF.
...
Portfolio fixes are limited to missing plotting imports, an undefined label variable, a prediction identifier path, notebook navigation, and removal of automatic competition submission. See [EDITS.md](https://github.com/arelakaunu/msc-data-science-portfolio/blob/main/EDITS.md).
