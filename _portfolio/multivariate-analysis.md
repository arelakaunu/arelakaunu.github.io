...
read_time: true
order: 6
project_type: "Analytical report"
stack: "R · Modelling · Visualisation"
excerpt: "Investigating glass composition, ocean temperatures, census income, and weekly stock data through statistical analysis."
---

[← All projects](/portfolio/){: .project-back}

[View project on GitHub](https://github.com/arelakaunu/msc-data-science-portfolio/tree/main/projects/multivariate-analysis){: .btn .btn--primary}

**Exploratory analysis · Statistical modelling · Visual communication · January 2025**

[Read the original report](/assets/portfolio/multivariate-analysis/report.pdf).
