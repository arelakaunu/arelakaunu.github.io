...
read_time: true
order: 4
project_type: "Computational experiment"
stack: "NumPy · emcee · Ray"
excerpt: "Exploring ensemble sampling, posterior summaries, and independent parallel chains on synthetic classification data."
---

[← All projects](/portfolio/){: .project-back}

[View project on GitHub](https://github.com/arelakaunu/msc-data-science-portfolio/tree/main/projects/ensemble-mcmc){: .btn .btn--primary}
...
[Open the notebook](https://github.com/arelakaunu/msc-data-science-portfolio/blob/main/projects/ensemble-mcmc/ensemble-mcmc.ipynb).
...
The from-scratch sampler was checked against the known covariance of its Gaussian target during preparation. Full `emcee`, Ray, and plotting execution was not performed. See [VALIDATION.md](https://github.com/arelakaunu/msc-data-science-portfolio/blob/main/VALIDATION.md).
